...
@pytest.mark.parametrize(
    ...
    ids=["min_page_and_size", "page_and_size_at_cap", "price_zero", "vram_zero",
         ...
         "category_at_max_length", "use_cases_at_cap", "pooling_false"],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"brand": "A" * (MAX_TEXT_LENGTH + 1)},
        {"use_case": ["training"] * (MAX_USE_CASES + 1)},
        {"use_case": ["A" * (MAX_TEXT_LENGTH + 1)]},
        {"sort_by": "listPrice"},
        {"sort_order": "sideways"},
        {"min_vram": 24},
        {"vram_gb": 24},
    ...
    ids=["page_zero", "page_negative", "page_over_cap", "page_skip_overflow",
         ...
         "fp16_inf", "category_too_long", "brand_too_long", "use_cases_over_cap",
         "use_case_element_too_long", "sort_by_raw_path", "sort_order_invalid",
